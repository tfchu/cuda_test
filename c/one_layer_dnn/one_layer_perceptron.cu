						...
						)
{
	...
	for (unsigned i = 0; i < 50; ++i) {
		...
		/*
		X_w: TRAINING_DIM (number of features per sample)
		X_h: TRAINING_SIZE (number of samples)
		X = [
			x0_f0 x0_f1 x0_f2 x0_f3
			x1_f0 x1_f1 x1_f2 x1_f3
			x2_f0 x2_f1 x2_f2 x2_f3
			...
		]
		line 1: 
